...
function kswitch(){
	if(flashInstaled) 
		...
		document.writeln("<PARAM NAME=movie VALUE='/i/ulh_eng2.swf'> <PARAM NAME=quality VALUE=high> <PARAM NAME=bgcolor VALUE=#FFFFFF> <EMBED src='/i/ulh_eng2.swf' quality=high bgcolor=#FFFFFF  WIDTH='777' HEIGHT='194' NAME='ulh' TYPE='application/x-shockwave-flash' PLUGINSPAGE='http://www.macromedia.com/go/getflashplayer'></EMBED>");
		...
		document.writeln('<div class=lang><span class=alang>English</span> | <a href="' + switch_version + '">Русский</a></div>');
		document.writeln('<div class=logo><img src="/i/logo_en.gif" width=127 height=39 border=0 alt="ULH"></div>');
		document.writeln('<div class=slogan><img src="/i/slogan_en.gif" width=253 height=39 border=0></div></td>');
		document.writeln('</tr>');
